    ...
    if (type == 'undefined') {
        return (
            <Container>
                ...
                <a target="_blank" href="https://github.com/arekminajj/spotify-you" rel="noreferrer">
    ...
    return (
        <Container>
            ...
            <Navbar>
                ...
                <Navbar.Collapse className="justify-content-end">
                    <Navbar.Text>
                        <a target="_blank" href={data.data.user.external_urls.spotify} rel="noreferrer">
                        ...
                        return (
                            <Table striped bordered hover variant="dark">
                                ...
                                <tr>
                                    <td>{idx + 1}</td>
                                    <td>
                                        <a target="_blank" href={d.external_urls.spotify} rel="noreferrer">
